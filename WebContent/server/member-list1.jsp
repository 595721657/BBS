...
<html class="x-admin-sm">
  ...
  <body class="">
    ...
    <div class="x-body">
      ...
      <table class="layui-table" lay-data="{url:'${pageContext.request.contextPath }/static/user.json',page:true,toolbar: '#toolbarDemo',id:'test'}" lay-filter="test">
        <thead>
          <tr>
