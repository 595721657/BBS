       ...
       <form class="layui-form">
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${tion.invitationid }" readonly="readonly">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                   <select name="plateId">
                      <c:forEach items="${plate }" var="p">
						<c:if test="${p.plateid==tion.plateid }" var="isok"> 
             ...
             <div class="layui-input-inline">
                 <select name="categoryId">
                   <c:forEach items="${category }" var="cate">
						<c:if test="${cate.categoryid==tion.categoryid }" var="isOK"> 
						  <option value="${cate.categoryid }" selected="selected">${cate.category }</option>
						</c:if>
						<c:if test="${!isOK }">
